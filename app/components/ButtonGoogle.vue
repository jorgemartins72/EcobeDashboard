<template>
  <div>
    <button class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-md font-medium ring ring-gray-300 border-input h-10 px-4 w-full py-6 cursor-pointer">
      <span class="mr-2">
